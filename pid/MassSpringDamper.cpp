...
double MassSpringDamper::acceleration(double u, double x, double Dx) const 
{
...
void MassSpringDamper::update(double u, double dt) 
{
    // RK4 integration
    double k1_v, k1_a, k2_v, k2_a, k3_v, k3_a, k4_v, k4_a;
    
    k1_v = Dx;
    k1_a = acceleration(u, x, Dx);
    
    k2_v = Dx + k1_a * dt/2;
    k2_a = acceleration(u, x + k1_v * dt/2, k1_v + k1_a * dt/2);
    
    k3_v = Dx + k2_a * dt/2;
    k3_a = acceleration(u, x + k2_v * dt/2, k2_v + k2_a * dt/2);
    
    k4_v = Dx + k3_a * dt;
    k4_a = acceleration(u, x + k3_v * dt, k3_v + k3_a * dt);
...
double MassSpringDamper::getVelocity() const 
{ 
    return Dx; 
}
